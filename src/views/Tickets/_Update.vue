    ...
    <div class="modal-body">
      <form class="row mb-3 g-9">
        ...
        <div class="col-sm-12">
          ...
          <select disabled v-model.number="ticket.idComputadora" class="form-select form-select-solid">
        ...
        <div class="col-sm-12">
          ...
          <select :disabled="ticket.solucion != null" v-model.number="ticket.prioridad" class="form-select form-select-solid">
